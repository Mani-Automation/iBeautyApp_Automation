Feature: iBeauty Regression Test
  ...
  @master @smoke @Regression @Login @positive
  ...
  @master @smoke @Regression @PLP @drive
  ...
  @master @smoke @Regression @Cart @drive
  ...
  @master @smoke @Regression @C360 @sprint_65 @dashboard
